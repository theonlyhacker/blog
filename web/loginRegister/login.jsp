...
<html>
  ...
  <form action="login" method="post">
      <div style="margin-left: 42%;height: 38" class="input-group mb-3">
          ...
          <input type="text" class="userinput" name="userName" id="username" placeholder="请输入用户名" onblur="check(this)" value="${user.username}"><%--<span id="name1" style="color: red;font-size: 15px;font-family: 'DejaVu Sans', Arial, Helvetica, sans-serif">*不能为空值</span>--%>
      </div>
      <div style="margin-left: 42%;height: 38" class="input-group mb-3">
          <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon2" style="height: 38">密&nbsp&nbsp&nbsp&nbsp码</span>
          </div>
          <input type="password" class="userinput" name="password" id="userpassword" placeholder="请输入密码"><span style="color: red;height: 20px;width: 300px;font-size: 15px">${errorMsg}</span>
