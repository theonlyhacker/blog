    ...
    <form action="personalInfoServlet" method="post">
        ...
        <div id="contermoddile" style="margin-left: 25%;width: 60%">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sex" id="sex1" value="男" ${user.sex=="男"?"checked":""} disabled>
                <label class="form-check-label" for="sex1">男</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sex" id="sex2" value="女" ${user.sex=="女"?"checked":""} disabled>
            ...
            <button type="button" class="btn btn-outline-secondary"><a href="exchangePersonalInfoServlet" style="text-decoration: none;color: #5a6268;">修改</a></button>
            </c:if>
